    ...
    <section class="bg-gray-100 py-8" id="pricing">
      <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
		...
		<h4 class="w-1/2 mx-auto mt-2 mb-8 leading-tight text-center text-gray-600">
			Once you design your document to satisfaction, <strong>5 coins</strong> will be deducted from your account when downloading the design.
		</h4>
        ...
        <div class="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
          ...
          <div class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white mt-4 sm:-mt-6 shadow-lg z-10">
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <div class="w-full p-8 text-3xl font-bold text-center">Quartely</div>
