		...
		<div>
			...
			<div class="flex w-full gap-4 mb-3">
				...
				<div class="w-1/4">
					...
					<select data-te-select-init v-model="draggable.font_weight" class="block w-full h-[2.15rem] rounded border border-solid border-neutral-300 px-3 py-1 text-neutral-700 outline-none focus:shadow">
			...
			<div class="flex w-full gap-4 mb-3">
				<div class="w-1/4">
					...
					<select data-te-select-init v-model="draggable.font_style" class="block w-full h-[2.15rem] rounded border border-solid border-neutral-300 px-3 py-1 text-neutral-700 outline-none focus:shadow">
						<option value="normal">Normal</option>
