		...
		<div>
			...
			<div class="flex w-full gap-4 mb-3">
				<div class="w-1/4">
					...
					<select data-te-select-init v-model="draggable.text_align" class="block w-full h-[2.15rem] rounded border border-solid border-neutral-300 px-3 py-1 text-neutral-700 outline-none focus:shadow">
				...
				<div class="w-1/4">
					...
					<input type="color" v-model="draggable.font_color" class="block w-full h-[2.15rem] rounded border border-solid border-neutral-300 px-3 py-1 text-neutral-700 outline-none focus:shadow"/>
				</div>
			</div>
			<div class="flex w-full gap-4 mb-3">
				<div class="w-1/2">
					...
					<div class="inline-block mr-6">
						<input
							...
							id="boldCheckbox"
							value="bold" 
							:checked="draggable.font_style.includes('bold')"
					...
					<div class="inline-block mr-6">
						<input
							...
							id="italicCheckbox"
							value="italic" 
							:checked="draggable.font_style.includes('italic')"
					...
					<div class="inline-block mr-6">
						<input
							...
							value="underline" 
							:checked="draggable.font_style.includes('underline')"
				...
				<div class="flex w-1/2 gap-4">
					<div class="w-1/2">
						...
						<input type="color" v-model="draggable.background_color" :disabled="draggable.background == 'none'" class="block w-full h-[2.15rem] rounded border border-solid border-neutral-300 px-3 py-1 mb-3 text-neutral-700 outline-none focus:shadow" />
					</div>
				...
				<div class="w-3/6">
					...
					<div class="inline-block mr-6">
						<input
							...
							value="yes"
							:checked="draggable.border_left == 'yes'"
					...
					<div class="inline-block mr-6">
						<input
							...
							value="yes" 
							:checked="draggable.border_top == 'yes'"
					...
					<div class="inline-block mr-6">
						<input
							...
							value="yes" 
							:checked="draggable.border_right == 'yes'"
					...
					<div class="inline-block mr-6">
						<input
							...
							value="yes" 
							:checked="draggable.border_bottom == 'yes'"
	...
	export default {
		...
		methods: {
			...
			toggleFontStyle(fontStyle) {
				if(this.draggable.font_style.includes(fontStyle)) {
					this.draggable.font_style.splice(this.draggable.font_style.indexOf(fontStyle), 1)
				}
				else {
					this.draggable.font_style.push(fontStyle)
				}
			},
			closeModal() {
