		...
		<div class="mt-4">
			<div class="flex w-full gap-4 mb-3">
				<div class="w-1/2">
					...
					<input type="number" v-model="documentStore.activeDraggable.columns" class="block w-full rounded border border-solid border-neutral-300 px-3 py-1 text-neutral-700 outline-none focus:shadow"/>
				</div>
				<div class="w-1/2">
					<label class="block">Number of Rows</label>
					<input type="number" v-model="documentStore.activeDraggable.rows" class="block w-full rounded border border-solid border-neutral-300 px-3 py-1 text-neutral-700 outline-none focus:shadow"/>
				</div>
			</div>
			<div class="flex w-full gap-4 mb-3">
				<div class="w-1/4">
